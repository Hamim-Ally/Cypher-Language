...
class Position:
    ...
    def copy(self): return Position(self.index, self.line, self.col, self.file_name, self.file_text)
...
class Lexer:
    ...
    def make_tokens(self):
        ...
        while self.current_char != None:
            ...
            elif self.current_char == '=': tokens.append(self.make_equals())
    ...
    def make_string(self):
        ...
        while self.current_char != None and (self.current_char != '"' or escape_character):
            if escape_character: string += escape_characters.get(self.current_char, self.current_char)
                ...
                if self.current_char == '\\': escape_character = True
