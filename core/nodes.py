...
class BinOpNode:
    ...
    def __repr__(
        self): return f'({self.left_node}, {self.op_tok}, {self.right_node})'
...
class EchoNode:
    def __init__(self, expression, pos_start, pos_end):
        ...
        self.pos_start = pos_start  # Use the start position of the expression
        self.pos_end = pos_end  # Use the end position of the expression
